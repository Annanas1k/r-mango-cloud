...
export const NewButtonDropDown = ({ children, className, createFolder, onUploadFileClick, onUploadFolderClick }: DropdownMenuBasicProps) => {
    ...
    <DropdownMenu>
      ...
      */}
      ...
      <DropdownMenuContent align="start" sideOffset={6} className="w-56">
        <DropdownMenuGroup>
          <DropdownMenuItem className="gap-2 cursor-pointer" onClick={()=>setOpenCreateFolder(true)}>
        ...
        <DropdownMenuGroup>
          <DropdownMenuItem className="gap-2 cursor-pointer" onClick={onUploadFileClick}>
            <FileUp className="h-4 w-4" /> 
            <span>{t('cloud-page.fileUpload')}</span>
          </DropdownMenuItem>
          <DropdownMenuItem className="gap-2 cursor-pointer" onClick={onUploadFolderClick}>
